...
/*
 * `rounded-full` → `rounded-sm`. A pill is the loudest "generic web component"
 * tell there is, and this product's own corners are 2px — the design review
 * counted ~15 pills in one viewport against a piece of hardware that has none.
 * `rounded-sm` is `max(0px, --radius - 4px)`, i.e. square at the current token,
 * which is what a silkscreened label on a panel actually looks like.
 */
