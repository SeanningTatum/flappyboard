...
const buttonVariants = cva(
  // `outline-none` was removed deliberately, not overlooked. It emits
  // `outline-style: none`, which suppressed the app-wide `:focus-visible`
  // outline in `app.css` AND removed the only focus indicator that survives
  // forced-colors / Windows High Contrast, where box-shadow is stripped
  // entirely. The ring below still paints the brand band on top of it.
